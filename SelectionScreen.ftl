		...
		<div class="container">
			<div class="col-auto mb-3"style="float:left;width:30em;">
				<div id="newGame" class="card mb-4 shadow-sm">
					<div id="newGame" class="card-header">
						<a href="http://localhost:7777/toptrumps/game"><button class="btn btn-outline-dark" >New Game</button></a>
					</div>
					<div class="card-body">
			...
			<div class="col-auto mb-3"style="float:right;width:30em;">
				<div id="newGame" class="card mb-4 shadow-sm">
					<div id="newGame" class="card-header">
						<a href="http://localhost:7777/toptrumps/stats"><button class="btn btn-outline-dark" >Game Statistics</button></a>
					</div>
					<div class="card-body">
